...
import { Caller, SecuritySession } from "../../../generated/prisma";
...
export default function ClientOnly({
  ...
  // useEffect(() => {
  //   const inProgressSession = assignedSessions.find(
  //     (session) => session.status === "in_progress"
  //   );
  //   if (inProgressSession) {
  //     setActiveSession(inProgressSession);
  //     setRecoveryPhrase(inProgressSession.recoveryPhrase || "");
  //   }
  // }, [assignedSessions]);
    ...
    <div className="container mx-auto py-8 px-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-gray-500">Welcome, {caller.name}</span>
          <Button
            variant="outline"
            onClick={refreshData}
